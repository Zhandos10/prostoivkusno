...
(function($) {
    "use strict";
		...
		jQuery(".orange-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "images/logo1.red.png");
			jQuery(".footer-logo .text-center img").attr("src", "images/logo1.red.png");
			return false;
		});

		jQuery(".strong-blue-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "images/logo.blue-removebg-preview.png");
			jQuery(".footer-logo .text-center img").attr("src", "images/logo.blue-removebg-preview.png");
			return false;
		});

		jQuery(".moderate-green-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "images/logo.green-removebg-preview.png");
			jQuery(".footer-logo .text-center img").attr("src", "images/logo.green-removebg-preview.png");
			return false;
		});

		jQuery(".vivid-yellow-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "images/logo.yellow-removebg-preview.png");
			jQuery(".footer-logo .text-center img").attr("src", "images/logo.yellow-removebg-preview.png");
			return false;
		});
